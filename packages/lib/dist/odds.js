 ...
 */
export function validateDecimalOdds(odds) {
 ...
 */
export function validateIndonesianOdds(odds) {
    if (typeof odds !== 'number' || isNaN(odds)) {
 ...
 * Validasi bet amount
 */
export function validateBetAmount(amount, minBet = 10000, maxBet = 10000000) {
 ...
 */
export function sanitizeProbability(probability) {
    if (typeof probability !== 'number' || isNaN(probability))
        return 50;
 ...
 */
export function sanitizeIndonesianOdds(odds) {
 ...
 */
export function calculateBetOutcome(betAmount, probability) {
 ...
 */
export function calculatePayoutIndonesian(betAmount, indoOdds) {
 ...
 */
export function indonesianOddsToProbability(indoOdds) {
    if (indoOdds > 0) {
 ...
 */
export function probabilityToIndonesianOdds(probability) {
    const prob = sanitizeProbability(probability);
...
export class ConstantProductMarketMaker {
    constructor(initialLiquidity = 1000000, initialProbability = 50) {
 ...
 */
export function calculateMultiOutcomeOdds(outcomes) {
 ...
 */
export function estimateProbabilityAfterBet(currentProbability, betAmount, totalVolume, isYesBet) {
 ...
 */
export function formatOddsDisplay(probability) {
    const odds = probabilityToOdds(probability);
    return {
